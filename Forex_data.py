...
Historical_Forex_data = pandas.DataFrame(yfinance.download(
    "EURUSD=X", start="2022-10-01", end="2024-06-01", interval="1h"
))

Historical_Forex_data.index = pandas.to_datetime(Historical_Forex_data.index).tz_localize(None).floor("s")
